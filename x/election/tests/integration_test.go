...
import (
	...
	_ "github.com/samricotta/vote/x/election/module"
	...
	electionmodulev1 "github.com/samricotta/vote/x/election/api/module/v1"
	"github.com/samricotta/vote/x/election/keeper"
)

// ExampleModule is a configurator.ModuleOption that add the election module to the app config.
var ExampleModule = func() configurator.ModuleOption {
	return func(config *configurator.Config) {
		config.ModuleConfigs[election.ModuleName] = &appv1alpha1.ModuleConfig{
			Name:   election.ModuleName,
			Config: appconfig.WrapAny(&electionmodulev1.Module{}),
		}
	}
}
